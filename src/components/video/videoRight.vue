<template>
 <section class="pdfRight_box">
        ...
        <div class="r-hide">
            <ul class="note-ul">
                <li class="note-li" @click="playByTime('1:13')">
                    <div class="li-top">
             ...
             <div class="btn-block-box" ><a href="#" class="btn-block" @click="addNote()">添加笔记</a> </div>
              <!-- <p class="btn-block-box">
                <slot :lastName="lastName">6666</slot>
...
export default {
    data () {
        return {
              lastName:'suntao',
              imgUrl:'https://x.cnki.net//Read/File/DownloadAttach?action=img&fileCode=a568ab2b-d023-478c-93a2-9346baac3683.jpe'
        };
    },
    computed:{
       ...mapState(['myPlayer']),
    ...
    methods: {
       ...
       addNote(){
            var _this = this;
            let currentTime = parseInt(_this.myPlayer.currentTime()); // 获取当前播放时间
            console.log(currentTime);
            console.log(this.timeFormat(currentTime));
