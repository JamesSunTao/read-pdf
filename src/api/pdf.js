...
export default {
    ...
    // 资源包接口
    GetPackFullInfos(data) {
        return get('LitNotes/GetPackFullInfos', data).then(dealResult);
    },
    GetPackExitFiles(data) {
        return post('litNotes/GetPackExitFiles', data).then(dealResult);
    },
    GetPackNotes(data) {
        return get('litNotes/GetPackNotes', data).then(dealResult);
    },
    ...
    // 编辑笔记
    SetEditNote(data){
        return post('LitNotes/EditNote', data).then(dealResult);
    },
    // 删除笔记
    delNote(data){
    ...
    getForReasonableTips(data){
        return post('LitNotes/ForReasonableTips', data).then(dealResult);
    },
    getStudyDetail(data){
